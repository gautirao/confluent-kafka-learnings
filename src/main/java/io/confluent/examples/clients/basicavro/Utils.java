...
public class Utils {
    public static final String SCHEMA_REGISTRY_URL = "https://psrc-0kywq.us-east-2.aws.confluent.cloud";
    public static final String CONFLUENT_CLOUD_USERNAME = "YVT2ZPARLNXMPCGA";
    public static final String CONFLUENT_CLOUD_API_KEY = "B7GWXvkptNFz7X/k5b38ABoukVDFhZYJMAm+g2Lu7b4CPd+ELGCxF0XCFSv8xGLd";
    public static final String BOOTSTRAP_SERVERS = "pkc-ymrq7.us-east-2.aws.confluent.cloud:9092";
    public static final String SCHEMA_REGISTRY_API_KEY = "dPl9EWzuoWd3RZ4V8OP6IgHeZaV1vyhAS7tyCguk/SyOjb61iypYr7AaLqSaUyKz";
    public static final String SCHEMA_REGISTRY_USER_NAME = "IUKGJ6KENRGOBNBL";
